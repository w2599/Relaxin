...
make ipa tipa \
     ...
     IPA_OUTPUT="${HOME}/www/html/TS/Relaxin_v${APP_VERSION}_${CURRENT_PROJECT_VERSION}_whitelist.ipa" \
     TIPA_OUTPUT="${HOME}/www/html/TS/Relaxin_v${APP_VERSION}_${CURRENT_PROJECT_VERSION}_whitelist_TS.tipa"
